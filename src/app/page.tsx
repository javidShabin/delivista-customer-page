  ...
  return (
    ...
    >
      <img
        ...
        className="w-[50px] sm:w-[80px] absolute top-28 sm:top-20 right-16 sm:right-56 animate-slideRight"
      />
      <img
      ...
      <img
        ...
        className="w-[70px] sm:w-[120px] absolute bottom-32 left-20 sm:left-80 animate-slideRight"
      />
      <img
      ...
      <img
        ...
        className="w-[70px] sm:w-[110px] absolute bottom-20 sm:bottom-60 right-10 animate-slideRight"
      />
      <img
        src="/assets/images/chilly1.png"
        className="w-[90px] sm:w-[150px] absolute bottom-96 sm:bottom-60 left-0 animate-slideRight"
      />
