...
const RestaurantRegistration = () => {
  ...
  const getFieldsForSection = (section: number): (keyof FormData)[] => {
    switch (section) {
      case 1:
        return ['businessName', 'contactName', 'email', 'phone', 'description'];
      case 2:
        return ['address', 'city', 'state', 'zipCode', 'deliveryRadius'];
      case 3:
        return ['cuisineType', 'openingHours'];
      case 4:
        return ['licenseNumber', 'taxId', 'bankAccount', 'agreeToTerms'];
      default:
        return [];
    }
  };
